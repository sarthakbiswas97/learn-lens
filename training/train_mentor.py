...
HF_REPO = "sarthakbiswas/learnlens-mentor-sft-v1"
...
def train(
    ...
    # Validate data BEFORE loading model
    if dry_run:
        dummy_records = [
            {
                "messages": [
    ...
    adapter_dir = out_dir / "lora-mentor"
...
def main(
    data: str = "training/data/mentor_data.jsonl",
    output_dir: str = "training/output/mentor-sft-v1",
    dry_run: bool = False,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train mentor LoRA adapter")
    parser.add_argument("--data", type=str, default="training/data/mentor_data.jsonl")
    parser.add_argument("--output-dir", type=str, default="training/output/mentor-sft-v1")
